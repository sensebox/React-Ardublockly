...
const VERSION = '1.0.0';
const getCompilationCounter = () => {
  const counter = parseInt(localStorage.getItem('compilationCounter') || '0');
  localStorage.setItem('compilationCounter', (counter + 1).toString());
  return counter + 1;
};
...
class Compile extends Component {
  ...
  compile = () => {
    ...
    // Add version and compilation info as header comment
    const versionHeader = `/*
     * Generated by senseBox Blockly
     * Version: ${VERSION}
     * Compilation #: ${counter}
    ...
    const data = {
      board:
        ...
        this.props.selectedBoard === "mini"
          ? "sensebox-mcu"
          : "sensebox-esp32s2",
      sketch: versionHeader + this.props.arduino,
    };
