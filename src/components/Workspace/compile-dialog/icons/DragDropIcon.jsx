...
import { File, Folder, Monitor, Image, Star, HardDrive } from "lucide-react";
...
export function DragDropIcon() {
  console.log("[DragDropIcon] Rendering");
    ...
    >
      ...
      >
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
          <SidebarItem>
            <Star className="text-[#48D7E7]" />
            <span>Schnellzugriff</span>
          </SidebarItem>
          <SidebarItem>
            <Monitor className="text-[#48D7E7]" />
            <span>Desktop</span>
          </SidebarItem>
          <SidebarItem>
            <Folder className="text-[#48D7E7]" />
            <span>Downloads</span>
          </SidebarItem>
          <SidebarItem>
            <File className="text-[#48D7E7]" />
            <span>Dokumente</span>
          </SidebarItem>
          <SidebarItem>
            <Image className="text-[#48D7E7]" />
            <span>Bilder</span>
          </SidebarItem>
          <Box sx={{ mt: 2 }}>
            <motion.div
      ...
      >
        ...
        >
          <File className="w-4 h-4 text-[#4B5563]" />
