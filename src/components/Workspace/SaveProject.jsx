...
class SaveProject extends Component {
    ...
    if (this.props.message !== prevProps.message) {
      if (this.props.message.id === "PROJECT_UPDATE_SUCCESS") {
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: Blockly.Msg.messages_PROJECT_UPDATE_SUCCESS,
          type: "success",
        });
        ...
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: Blockly.Msg.messages_GALLERY_UPDATE_SUCCESS,
          type: "success",
        });
        ...
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: Blockly.Msg.messages_PROJECT_UPDATE_FAIL,
          type: "error",
        });
        ...
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: Blockly.Msg.messages_GALLERY_UPDATE_FAIL,
          type: "error",
        });
        ...
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: "Classroom project saved successfully",
          type: "success",
        });
        ...
        this.setState({
          snackbar: true,
          key: Date.now(),
          message: "Failed to save classroom project",
          type: "error",
        });
      }
    }
      ...
      const config = {
        ...
        error: (err) => {
          this.setState({
            snackbar: true,
            key: Date.now(),
            message: `${Blockly.Msg.messages_gallery_save_fail_1} ${this.state.projectType === "gallery" ? "Galerie-" : ""} ${Blockly.Msg.messages_gallery_save_fail_2}`,
            type: "error",
          });
          window.scrollTo(0, 0);
        },
  ...
  workspaceDescription = () => {
    ...
    this.setState({ projectType: "gallery" }, () => this.saveProject());
  };
      ...
      <div style={this.props.style}>
        <Tooltip
          title={
            this.state.projectType === "project"
              ? Blockly.Msg.tooltip_update_project
              : Blockly.Msg.tooltip_save_project
          }
          arrow
        >
          <IconButton
        ...
        >
          ...
          >
            {this.state.projectType === "project"
              ? Blockly.Msg.tooltip_update_project
              : Blockly.Msg.tooltip_create_project}
          </MenuItem>
          <MenuItem
            onClick={
          ...
          >
            {this.state.projectType === "gallery"
              ? "Galerie-Projekt aktualisieren"
              : "Galerie-Projekt erstellen"}
          </MenuItem>
        </Menu>
