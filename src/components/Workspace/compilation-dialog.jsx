...
function CompilationDialog({
  ...
  // Verwende Blockly.Msg für die Übersetzungen
  const steps = [
    {
...
const mapStateToProps = (state) => ({
  ...
  selectedBoard: state.board.selectedBoard, // Beispiel: weitere benötigte Werte
});

export default connect(mapStateToProps, null)(CompilationDialog);
