...
/**
 * Generic ConvertDeployBase Component
 *
 * Provides the UI and logic for converting and deploying trained models.
 * Can be used for image, spell, or other model types.
 *
 * @component
 * @param {Object} props
 * @param {Object} props.model - The trained model object containing:
 *   - model: tf.LayersModel
 *   - classes: Array of class objects
 *   - representativeSamples: Array of sample data for quantization
 *   - inputShape: Input shape of the model
 * @param {Object} props.translations - Translation object with properties:
 *   - integration.reconvertModel
 *   - integration.converting
 *   - integration.convertModel
 *   - integration.retry
 *   - integration.suggestions
 *   - integration.modelConvertedSuccess
 *   - integration.chooseOptions
 *   - integration.optionA
 *   - integration.optionADescription
 *   - integration.downloadCppFile
 *   - integration.optionB
 *   - integration.optionBDescription
 *   - integration.compiling
 *   - integration.compileAndDownload
 *   - integration.downloadBinaryAgain
 *   - integration.successBinaryDownloaded
 *   - integration.successBinaryDescription
 * @param {string} props.boardType - Target board type (default: 'sensebox_mcu_eye')
 * @param {string} props.modelName - Name for the model in download filenames (default: 'teachable_machine')
 * @returns {JSX.Element} The component JSX
 */
const ConvertDeployBase = ({
  model,
  translations,
  ...
  }, [workflowState.conversionData, model, boardType, modelName]);
...
export default ConvertDeployBase;
