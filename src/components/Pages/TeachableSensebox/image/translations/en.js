// src/components/Pages/TeachableSensebox/image/translations/en.js
export const imageClassificationTranslations_en = {
  ...
  training: {
    ...
    stopSenseBoxCamera: "Stop senseBox MCU Eye Camera",
    startSenseBoxCamera: "Start senseBox MCU Eye Camera",
    ...
    errorUploadFailed: "Failed to upload images.",
    errorWrongFormat: "This zip file does not contain valid images.",
    downloadData: "Download Images",
    uploadData: "Upload Images",
    downloadTrainScript: "Download Collect-Sketch",
  ...
  integration: {
    ...
    optionBDescription:
      "Integrate the model into a prebuilt sketch. This sketch will display the camera image and the prediction on the OLED display. Compiling the sketch will take some time. Once downloaded, you can upload it directly to your senseBox MCU Eye via drag-and-drop.",
    compiling: "Compiling...",
  ...
  errors: {
    ...
    browserNotSupportedMessage:
      "Your browser does not support the Web Serial API required for senseBox MCU Eye camera connection.",
    ...
    permissionDeniedMessage:
      "Serial port access was denied. Please grant permission to connect to your senseBox MCU Eye camera.",
    ...
    deviceDisconnectedMessage: "The senseBox MCU Eye camera was disconnected.",
    deviceDisconnectedDetails: "Please reconnect your device and try again.",
    frameTimeout: "Frame Timeout",
    frameTimeoutMessage:
      "No frames received from the senseBox MCU Eye camera within the expected time.",
    frameTimeoutDetails:
    ...
    frameCorruptedMessage:
      "Received a corrupted frame from the senseBox MCU Eye camera.",
    ...
    frameDecodingErrorMessage:
      "Failed to decode frame data from the senseBox MCU Eye camera.",
    ...
    unknownErrorMessage:
      "An unexpected error occurred with the senseBox MCU Eye camera.",
    ...
    troubleshootingFirmware:
      "Verify the senseBox MCU Eye is running the firmware to stream camera images. You can download it with the button below.",
    ...
    waitingForFrames:
      "Waiting for frames from senseBox MCU Eye camera... If this persists, check your device connection.",
  },
  help: {
    help: "Help",
    imageClassification: {
