// src/components/Pages/TeachableSensebox/image/translations/de.js
export const imageClassificationTranslations_de = {
  ...
  training: {
    ...
    samples: "Bilder",
    captureImage: "Beispielbild aufnehmen",
    ...
    errorUploadFailed: "Das Hochladen der Bilder ist fehlgeschlagen.",
    errorWrongFormat: "Diese Zip-Datei enthält keine gültigen Bilder.",
    downloadData: "Bilder herunterladen",
    uploadData: "Bilder hochladen",
    downloadTrainScript: "Sammel-Sketch herunterladen",
    ...
    tooltip: {
      helpMain: "Was ist Bildklassifizierung?",
      browserCompatible:
