...
export const teachableMachineTranslations_de = {
  ...
  integration: {
    ...
    serializingModel: "Serialisiere Modell...",
    uploadingToServer: "Lade zum Server hoch...",
    convertingToTFLite: "Konvertiere zu TFLite...",
    generatingCode: "Generiere C/C++ Code...",
    convertingModel: "Konvertiere Modell...",
    compilingToBinary: "Kompiliere Modell zu Binärdatei...",
