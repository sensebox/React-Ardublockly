        ...
        {this.state.checked ? (
          <div>
            ...
            {this.state.radioValue === "picture" ? (
              <div>
                {!this.props.error ? (
                  ...
                  <div
                    ...
                    className={
                      this.props.error ? this.props.classes.errorBorder : null
                    }
                  >
                    {this.state.error ? (
                      <FormHelperText
                      ...
                      >{`Die übergebene Datei entspricht nicht dem geforderten Bild-Format. Überprüfe, ob es sich um ein Bild handelt und versuche es nochmal.`}</FormHelperText>
                    ) : (
                      <FormHelperText
                        style={{
                          lineHeight: "initial",
                        ...
                        className={this.props.classes.errorColor}
                      >{`Wähle ein Bild aus.`}</FormHelperText>
                    )}
                  </div>
                )}
                {/*upload picture*/}
                <div>
                  ...
                  <label htmlFor={`picture ${this.props.index}`}>
                    <Button
                      component="span"
                      className={
                        this.props.error ? this.props.classes.errorButton : null
                      }
                      style={{
                        marginRight: "10px",
                        marginBottom: "10px",
              ...
              <div>
                <Textfield
                  value={this.props.value && this.props.value.youtube}
                  property={"media"}
                  property2={"youtube"}
                  label={"Youtube-ID"}
                  index={this.props.index}
                  error={this.props.error}
                  errorText={`Gib eine Youtube-ID ein.`}
                />
                {this.props.youtube && !this.props.error ? (
                  ...
                  <div style={{ maxWidth: "800px" }}>
                    ...
                    >{`Stelle sicher, dass das unten angezeigte Youtube-Video funktioniert, andernfalls überprüfe die Youtube-ID.`}</FormHelperText>
                    <div
                      style={{
                        position: "relative",
                        height: 0,
                    ...
                    >
                      <iframe
                        ...
                        src={`https://www.youtube.com/embed/${this.props.youtube}`}
                        frameBorder="0"
...
export default connect(null, {
  ...
  setError,
  deleteError,
})(withStyles(styles, { withTheme: true })(Media));
