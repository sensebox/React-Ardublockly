  ...
  render() {
    return (
      <div style={{ display: "inline-flex", marginTop: "15px" }}>
        ...
        >
          ...
          {this.props.error ? (
            <FormHelperText className={this.props.classes.errorColor}>
              Gib eine positive ganzzahlige Zahl ein.
            </FormHelperText>
          ) : null}
        </FormControl>
        <FormHelperText
        ...
        >
          Beachte, dass die ID eindeutig sein muss. Sie muss sich also zu den
          anderen Tutorials unterscheiden.
        </FormHelperText>
      </div>
    );
  }
...
export default connect(mapStateToProps, { tutorialId, setError, deleteError })(
  withStyles(styles, { withTheme: true })(Id),
);
