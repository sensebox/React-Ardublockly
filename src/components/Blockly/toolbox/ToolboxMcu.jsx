    ...
    <>
      ...
      >
        ...
        >
          ...
          {/* -------- INTERNAL RTC -------- */}
          <Label text={Blockly.Msg.toolbox_label_internalRTC} />
          <Block type="sensebox_internal_rtc_init" />
          <Block type="sensebox_internal_rtc_set" />
          <Block type="sensebox_internal_rtc_get" />
          <Block type="sensebox_internal_rtc_get_timestamp" />
        </Category>
