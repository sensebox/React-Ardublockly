...
Blockly.Blocks["sensebox_http_on_client_connect"] = {
  init: function () {
    ...
    this.appendDummyInput().appendField(
      Blockly.Msg.senseBox_http_on_client_connect,
    );
...
Blockly.Blocks["sensebox_http_method"] = {
  init: function () {
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_http_method);
...
Blockly.Blocks["sensebox_http_uri"] = {
  init: function () {
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_http_uri);
    this.setOutput(true, Types.TEXT.typeName);
    this.setColour(getColour().webserver);
...
Blockly.Blocks["sensebox_http_protocol_version"] = {
  init: function () {
    this.appendDummyInput().appendField(
      Blockly.Msg.senseBox_http_protocol_version,
    );
    this.setOutput(true, Types.TEXT.typeName);
    this.setColour(getColour().webserver);
...
Blockly.Blocks["sensebox_ip_address"] = {
  init: function () {
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_ip_address);
...
Blockly.Blocks["sensebox_http_user_agent"] = {
  init: function () {
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_http_user_agent);
    this.setOutput(true, Types.TEXT.typeName);
    this.setColour(getColour().webserver);
...
Blockly.Blocks["sensebox_generate_http_succesful_response"] = {
  init: function () {
    this.setColour(getColour().webserver);
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_http_success);
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_http_success_l2);
...
Blockly.Blocks["sensebox_general_html_tag"] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(">");
    this.appendValueInput("DO0").setCheck(getCompatibleTypes("String"));
    this.setInputsInline(false);
    this.setOutput(true, Types.TEXT.typeName);
    this.setHelpUrl("https://sensebox.de/books");
  ...
  domToMutation: function (xmlElement) {
    this.additionalChildCount_ =
      parseInt(xmlElement.getAttribute("add_child"), 10) || 0;
    this.updateShape_();
  },
  /**
