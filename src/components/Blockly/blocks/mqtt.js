...
Blockly.Blocks["sensebox_mqtt_setup"] = {
  ...
  onchange: function (e) {
    ...
    switch (service) {
      ...
      case "custom":
        if (
          this.getField("server").getValue() === "io.adafruit.com" ||
          this.getField("server").getValue() === "mqtt.dioty.co"
        ) {
...
Blockly.Blocks["sensebox_mqtt_publish"] = {
  init: function () {
    this.setColour(getColour().mqtt);
    this.appendDummyInput().appendField(Blockly.Msg.senseBox_mqtt_publish);
...
Blockly.Blocks["sensebox_mqtt_subscribe"] = {
  init: function () {
    this.setColour(getColour().mqtt);
    this.appendDummyInput().appendField(Blockly.Msg.sensebox_mqtt_subscribe);
    this.appendDummyInput().appendField(
      new Blockly.FieldTextInput("Feedname"),
      "subscribefeed",
    );
