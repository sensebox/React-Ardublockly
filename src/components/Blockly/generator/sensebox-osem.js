...
Blockly.Generator.Arduino.forBlock["sensebox_osem_connection"] = function (
  block,
  generator,
) {
...
Blockly.Generator.Arduino.forBlock["sensebox_esp32s2_osem_connection"] =
  function (block, generator) {
    ...
    if (ssl === "TRUE") {
      ...
      Blockly.Generator.Arduino.definitions_["root_ca"] = `const char* root_ca =
      "-----BEGIN CERTIFICATE-----\\n"
      ...
      "-----END CERTIFICATE-----\\n";`;
      Blockly.Generator.Arduino.setupCode_["wifiClientSecure_setRootCa"] =
