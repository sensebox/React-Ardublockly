...
Blockly.Arduino.sensebox_motors_beginServoMotor = function () {
  ...
  Blockly.Arduino.definitions_[`define_servo_motor_${pin}`] =
    `Servo servo_motor_${pin}; // servo Motor`;
  Blockly.Arduino.setupCode_[`setup_servo_motor_${pin}`] =
...
Blockly.Arduino.sensebox_motors_I2CMotorBoard_begin = function () {
  Blockly.Arduino.libraries_["include_i2c_motor_board"] =
...
Blockly.Arduino.sensebox_motors_I2CMotorBoard_moveDCMotor = function () {
  ...
  var speed =
    Blockly.Arduino.valueToCode(this, "speed", Blockly.Arduino.ORDER_ATOMIC) ||
    "50";
...
Blockly.Arduino.sensebox_motors_moveStepperMotor = function () {
  var steps =
    Blockly.Arduino.valueToCode(this, "steps", Blockly.Arduino.ORDER_ATOMIC) ||
    "2048";
