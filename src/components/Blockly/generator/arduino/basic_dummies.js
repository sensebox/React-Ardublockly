...
Blockly.Generator.Arduino.forBlock["basic_brightness"] = function (
  _block,
  _generator,
) {
  return ""; // nichts generieren
...
Blockly.Generator.Arduino.forBlock["display_show_measurement"] = function (
  _block,
  _generator,
) {
  return ""; // nichts generieren
...
Blockly.Generator.Arduino.forBlock["colour_picker_basic"] = function (
  _block,
  _generator,
) {
  return ""; // nichts generieren
...
Blockly.Generator.Arduino.forBlock["basic_repeat_until"] = function (
  _block,
  _generator,
) {
  return ""; // nichts generieren
