...
Blockly.Generator.Arduino.forBlock["sensebox_ws2812_matrix_drawPixel"] = function (
  block,
) {
  var dropdown_pin = this.getFieldValue("Port");
...
Blockly.Generator.Arduino.forBlock["sensebox_ws2812_matrix_showBitmap"] = function (
  block,
) {
  var dropdown_pin = this.getFieldValue("Port");
  var value =
