...
Blockly.Arduino.sensebox_scd30 = function () {
  ...
  Blockly.Arduino.loopCodeOnce_["scd30loop"] = `if (airSensor.dataAvailable()) {
  scdco2 = airSensor.getCO2();
  scdtemp = airSensor.getTemperature();
  scdhumi = airSensor.getHumidity();
}
  `;
