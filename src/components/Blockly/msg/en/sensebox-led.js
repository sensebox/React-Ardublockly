export const LED = {
  ...
  senseBox_ws2812_rgb_matrix_draw_bitmap_tooltip: `Display a bitmap of color values on the LED-Matrix.
  For example, the **Motive** or **Write/Paint your own bitmap** blocks from the LED-Matrix category. Alternatively, the ToF Distance Imager can also output a bitmap.`,
