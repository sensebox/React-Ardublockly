export const LED = {
  ...
  senseBox_ws2818_rgb_led_init_tooltip: `Connect the RGB LED to one of the **digital/analog ports**. If multiple RGB LEDs are daisy-chained together you can determine which LED is controlled by position.`,
  ...
  senseBox_ws2812_rgb_matrix_custom_bitmap_example:
    `{0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xB5B6,   // 0x0010 (16) pixels\n` +
