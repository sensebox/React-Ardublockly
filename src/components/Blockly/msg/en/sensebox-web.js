export const WEB = {
  ...
  senseBox_esp_now_receive: "When message %1 received",
  senseBox_esp_now_receive_tooltip: "Do the following, when you receive a message",
  senseBox_wifi_mac: "Mac-Address",
  senseBox_esp_now_send: "Send message to receiver",
  senseBox_esp_now_send_tooltip: "Send message to receiver",
  senseBox_wifi_mac_tooltip: "The Mac-Address of the senseBox",
