export const FLUORO = {
  tooltip_text: `With the QOOOL Fluoro you can explore the basics of fluorescence - directly in the Blockly environment. In this digital experiment, you control coloured LEDs and combine them with different colour filters. Particularly exciting: some filters contain a microdiamond with so-called NV centres (nitrogen vacancy centres). These special defects can be excited by light and then emit some of the energy in the form of visible light. This effect is called fluorescence.
