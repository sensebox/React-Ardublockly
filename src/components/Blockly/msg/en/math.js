export const MATH = {
  ...
  MATH_ARITHMETIC_TOOLTIP: "Arithmetic operations on two numbers.",
  ...
  MATH_CHANGE_INCREASE: "increase",
  MATH_CHANGE_DECREASE: "decrease",
  MATH_CHANGE_TOOLTIP: "Adds/Subtracts a number to/from a variable.",
  MATH_CHANGE_TOOLTIP_WITH_VARIABLE:
    "Adds/Subtracts a number to/from the variable '%1'.",
  ...
  MATH_NUMBER_TOOLTIP:
    "A number. It can be a whole number (0, -1, 4, ...) or a decimal number (0.5, 3.14, ...).",
  MATH_ONLIST_HELPURL: "",
  ...
  MATH_SINGLE_TOOLTIP: "Single operations on a number.",
  ...
  MATH_TRIG_TOOLTIP: "Trigonometric operations.",
  MATH_TRIG_SIN: "sin",
  MATH_TRIG_TAN: "tan",
