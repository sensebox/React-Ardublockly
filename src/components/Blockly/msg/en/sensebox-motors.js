export const MOTORS = {
  ...
  sensebox_motors_beginServoMotor_tooltip:
    "Connect one of the the digital pins to the orange wire of the Servo Motor. Also Connect GND to GND (black and brown wire) and 5V to 5V (red wire).",
  ...
  sensebox_motors_moveServoMotor_tooltip:
    "The Servo Motor can be moved to a spezific angle between 0 and 180 degrees.",
