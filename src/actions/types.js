...
export const TUTORIAL_PROGRESS_SET_ALL = "TUTORIAL_PROGRESS_SET_ALL";
export const TUTORIAL_PROGRESS_START = "TUTORIAL_PROGRESS_START";
export const TUTORIAL_PROGRESS_STEP_SEEN = "TUTORIAL_PROGRESS_STEP_SEEN";
export const TUTORIAL_PROGRESS_ANSWER = "TUTORIAL_PROGRESS_ANSWER";
export const TUTORIAL_PROGRESS_RESET = "TUTORIAL_PROGRESS_RESET";
