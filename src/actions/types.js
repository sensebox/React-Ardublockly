...
export const CLEAR_DEVICE_PORT = "CLEAR_DEVICE_PORT";
export const SET_BOOTLOADER_PORT = "SET_BOOTLOADER_PORT";
export const CLEAR_BOOTLOADER_PORT = "CLEAR_BOOTLOADER_PORT";
